...
/**
 * Description of any class representing a shape for collision. The shape both
 * defines the geometry and the collision properties. However, these can be
 * augmented at the Body level.
 * 
 * @author kevin
 */
public interface Shape
{
     ...
     * 
     * @param body
     *            The body to create the shape within
     */
     ...
     * 
     * @param rest
     *            The restitution applied to this shape
     */
     ...
     * 
     * @param friction
     *            The friction applied to this shape
     */
     ...
     * 
     * @param density
     *            The density applied to this shape
     */
