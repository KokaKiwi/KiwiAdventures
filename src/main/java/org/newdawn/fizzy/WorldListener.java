...
public interface WorldListener
{
     ...
     * 
     * @param event
     *            The event describing the collision
     */
    public void collided(CollisionEvent event);
    
    /**
     * Notification that two bodies have now separated (after having collided)
     * within the simulation
     * 
     * @param event
     *            The event describing which bodies have separated
     */
