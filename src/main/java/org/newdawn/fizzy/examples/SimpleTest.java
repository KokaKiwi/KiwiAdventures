...
/**
 * A simple sanity test. Circle falls, hits rectangle, collision events are
 * fired
 * 
 * @author kevin
 */
public class SimpleTest
{
    ...
    public static void main(String[] argv)
    {
        ...
        final Body body = new DynamicBody(new Circle(10.0f), 0, 0);
        world.add(body);
        final Body floor = new StaticBody(new Rectangle(200.0f, 10.0f), -100,
                -55.0f);
        world.add(floor);
