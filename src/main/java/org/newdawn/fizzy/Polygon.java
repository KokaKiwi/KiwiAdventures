...
public class Polygon extends PolygonBasedShape
{
     ...
     * 
     * @param points
     *            points in CCW order (as usual)
     */
    public void setPoints(Vec2[] points)
    {
        final Vec2[] scaledPoints = new Vec2[points.length];
    ...
    protected void applyOffset(float x, float y, float angle)
    {
        ...
        {
            final Vec2 vertex = shape.getVertex(i);
            // TODO Max: not sure this is right -- none of the examples test it.
            // Probably?
